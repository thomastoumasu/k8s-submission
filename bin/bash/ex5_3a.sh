...
kubectl apply -f istio/manifests/hello.yaml
kubectl apply -f istio/manifests/gateway.yaml
kubectl apply -f istio/manifests/route.yaml
...
kubectl apply -f istio/manifests/hello_twoversions.yaml
kubectl apply -f istio/manifests/route_twoversions.yaml
